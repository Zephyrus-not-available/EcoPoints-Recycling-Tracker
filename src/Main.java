import OOP.Household;
import OOP.RecyclingEvent;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            System.out.println("1. Register OOP.Household");
            System.out.println("2. Log Recycling Event");
            System.out.println("3. Display Households");
            System.out.println("4. Display OOP.Household Recycling Events");
    ...
    private static void registerHousehold() {
        ...
        if (households.containsKey(id)) {
            System.out.println("Error: OOP.Household ID already exists.");
            return;
        }
        ...
        System.out.println("OOP.Household registered successfully on " + household.getJoinDate());
    }
    ...
    private static void logRecyclingEvent() {
        ...
        if (household == null) {
            System.out.println("Error: OOP.Household ID not found.");
            return;
        }
    ...
    private static void displayHouseholdEvents() {
        ...
        if (household == null) {
            System.out.println("OOP.Household not found.");
            return;
        }
    ...
    private static void generateReports() {
        ...
        System.out.println("\nOOP.Household with Highest Points:");
    ...
    private static void loadHouseholdsFromFile() {
        try (
            ...
            System.out.println("OOP.Household data loaded.");
